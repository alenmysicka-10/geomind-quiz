...
// ══════════════════════════════════════════════════════════════════════════
  ...
  },
  {
    ...
    cs:{
      ...
      personalities:[
        {name:"Milan Rastislav Štefánik",hint:"Astronom a generál, spoluzakladatel Československa.",context:"spoluzakladatel ČSR"},
        {name:"Andy Warhol",hint:"Ikona pop-artu, jeho rodina pochází ze Slovenska.",context:"král pop-artu"},
        {name:"Ľudovít Štúr",hint:"Jazykovědec, který kodifikoval slovenský jazyk, a národní buditel.",context:"kodifikátor slovenštiny"}
      ],
    ...
    en:{
      ...
      personalities:[
        {name:"Milan Rastislav Štefánik",hint:"Astronomer and general, co-founder of Czechoslovakia.",context:"co-founder of Czechoslovakia"},
        {name:"Andy Warhol",hint:"Pop art icon, his family roots are from Slovakia.",context:"king of pop art"},
        {name:"Ľudovít Štúr",hint:"Linguist who standardised the Slovak language and key figure of national revival.",context:"standardiser of Slovak"}
      ],
      cities:["Bratislava","Košice","Prešov","Žilina"]
    }
  },
...
const LANDMARKS = {
  CZ:[
    {name:"Pražský hrad",              en:"Prague Castle",             built:870,  finished:1929, img:"https://source.unsplash.com/480x320/?prague,castle,hradcany"},
    {name:"Karlův most",               en:"Charles Bridge",            built:1357, finished:1402, img:"https://source.unsplash.com/480x320/?charles+bridge,prague,vltava"},
    {name:"Staroměstský orloj",        en:"Prague Astronomical Clock", built:1410, finished:1490, img:"https://source.unsplash.com/480x320/?astronomical+clock,prague,orloj"},
    {name:"Katedrála sv. Víta",        en:"St. Vitus Cathedral",       built:1344, finished:1929, img:"https://source.unsplash.com/480x320/?cathedral,prague,gothic"},
    {name:"Lednicko-valtický areál",   en:"Lednice–Valtice Cultural Landscape", built:1219, finished:1858, img:"https://source.unsplash.com/480x320/?chateau,lednice,czech+republic"},
    {name:"Kutná Hora — kostel sv. Barbory", en:"St. Barbara's Church Kutná Hora", built:1388, finished:1905, img:"https://source.unsplash.com/480x320/?kutna+hora,gothic+church,czech"},
    {name:"Hrad Karlštejn",            en:"Karlštejn Castle",          built:1348, finished:1365, img:"https://source.unsplash.com/480x320/?karlstejn,czech+castle,medieval"},
    {name:"Telč — historické centrum", en:"Historic Centre of Telč",   built:1530, finished:1560, img:"https://source.unsplash.com/480x320/?telc,czech+town,renaissance"},
    {name:"Třebíčská bazilika",        en:"Třebíč Basilica",           built:1101, finished:1240, img:"https://source.unsplash.com/480x320/?trebic,basilica,czech"},
    {name:"Kroměřížský zámek",         en:"Kroměříž Chateau",          built:1686, finished:1752, img:"https://source.unsplash.com/480x320/?kromeriz,chateau,baroque"},
  ],
  DE:[
    {name:"Braniborská brána",         en:"Brandenburg Gate",          built:1788, finished:1791, img:"https://source.unsplash.com/480x320/?brandenburg+gate,berlin,germany"},
    {name:"Norimberský hrad",          en:"Nuremberg Castle",          built:1050, finished:1571, img:"https://source.unsplash.com/480x320/?nuremberg,castle,germany"},
    {name:"Kolínský dóm",              en:"Cologne Cathedral",         built:1248, finished:1880, img:"https://source.unsplash.com/480x320/?cologne+cathedral,dom,germany"},
    {name:"Neuschwanstein",            en:"Neuschwanstein Castle",     built:1869, finished:1892, img:"https://source.unsplash.com/480x320/?neuschwanstein,bavaria,castle"},
    {name:"Berlínská zeď — Memorial", en:"Berlin Wall Memorial",       built:1961, finished:1961, img:"https://source.unsplash.com/480x320/?berlin+wall,germany,memorial"},
    {name:"Říšský sněm (Reichstag)",   en:"Reichstag Building",        built:1884, finished:1999, img:"https://source.unsplash.com/480x320/?reichstag,berlin,parliament"},
    {name:"Heidelberský zámek",        en:"Heidelberg Castle",         built:1214, finished:1764, img:"https://source.unsplash.com/480x320/?heidelberg,castle,germany"},
    {name:"Sanssouci",                 en:"Sanssouci Palace",          built:1745, finished:1747, img:"https://source.unsplash.com/480x320/?sanssouci,potsdam,palace"},
    {name:"Wartburg",                  en:"Wartburg Castle",           built:1067, finished:1080, img:"https://source.unsplash.com/480x320/?wartburg,thuringia,castle"},
    {name:"Drážďanská opera",          en:"Dresden Semperoper",        built:1838, finished:1878, img:"https://source.unsplash.com/480x320/?dresden,opera,semperoper"},
  ],
  FR:[
    {name:"Eiffelova věž",             en:"Eiffel Tower",              built:1887, finished:1889, img:"https://source.unsplash.com/480x320/?eiffel+tower,paris,france"},
    {name:"Louvre",                    en:"Louvre Museum",             built:1190, finished:1989, img:"https://source.unsplash.com/480x320/?louvre,paris,museum"},
    {name:"Notre-Dame de Paris",       en:"Notre-Dame de Paris",       built:1163, finished:1345, img:"https://source.unsplash.com/480x320/?notre+dame,paris,cathedral"},
    {name:"Versailleský palác",        en:"Palace of Versailles",      built:1661, finished:1710, img:"https://source.unsplash.com/480x320/?versailles,palace,france"},
    {name:"Mont Saint-Michel",         en:"Mont Saint-Michel",         built:709,  finished:1523, img:"https://source.unsplash.com/480x320/?mont+saint+michel,normandy,france"},
    {name:"Sacré-Cœur",               en:"Sacré-Cœur Basilica",       built:1875, finished:1914, img:"https://source.unsplash.com/480x320/?sacre+coeur,paris,montmartre"},
    {name:"Pont du Gard",              en:"Pont du Gard",              built:40,   finished:60,   img:"https://source.unsplash.com/480x320/?pont+du+gard,aqueduct,france"},
    {name:"Carcassonne",               en:"Carcassonne Citadel",       built:100,  finished:1285, img:"https://source.unsplash.com/480x320/?carcassonne,medieval,fortress"},
    {name:"Palais des Papes",          en:"Palace of the Popes",       built:1335, finished:1364, img:"https://source.unsplash.com/480x320/?avignon,pope+palace,france"},
    {name:"Triomfální oblouk",         en:"Arc de Triomphe",           built:1806, finished:1836, img:"https://source.unsplash.com/480x320/?arc+de+triomphe,paris,champs+elysees"},
  ],
  IT:[
    {name:"Koloseum",                  en:"Colosseum",                 built:70,   finished:80,   img:"https://source.unsplash.com/480x320/?colosseum,rome,italy"},
    {name:"Šikmá věž v Pise",          en:"Leaning Tower of Pisa",     built:1173, finished:1372, img:"https://source.unsplash.com/480x320/?pisa,leaning+tower,italy"},
    {name:"Benátky — Grand Canal",     en:"Venice Grand Canal",        built:421,  finished:1500, img:"https://source.unsplash.com/480x320/?venice,grand+canal,gondola"},
    {name:"Pantheon",                  en:"Pantheon Rome",             built:27,   finished:125,  img:"https://source.unsplash.com/480x320/?pantheon,rome,ancient"},
    {name:"Sixtinská kaple",           en:"Sistine Chapel",            built:1473, finished:1481, img:"https://source.unsplash.com/480x320/?sistine+chapel,vatican,michelangelo"},
    {name:"Bazilika sv. Petra",        en:"St. Peter's Basilica",      built:1506, finished:1626, img:"https://source.unsplash.com/480x320/?st+peters,vatican,basilica"},
    {name:"Trevi fontána",             en:"Trevi Fountain",            built:1732, finished:1762, img:"https://source.unsplash.com/480x320/?trevi+fountain,rome,italy"},
    {name:"Pompeje",                   en:"Pompeii",                   built:-600, finished:-79,  img:"https://source.unsplash.com/480x320/?pompeii,ruins,vesuvius"},
    {name:"Palác Dóžat",               en:"Doge's Palace",             built:810,  finished:1424, img:"https://source.unsplash.com/480x320/?doge+palace,venice,italy"},
    {name:"Matera — Sassi",            en:"Sassi di Matera",           built:-7000,finished:700,  img:"https://source.unsplash.com/480x320/?matera,sassi,cave+dwellings"},
  ],
  ES:[
    {name:"Sagrada Família",           en:"Sagrada Família",           built:1882, finished:2026, img:"https://source.unsplash.com/480x320/?sagrada+familia,barcelona,gaudi"},
    {name:"Alhambra",                  en:"Alhambra",                  built:889,  finished:1354, img:"https://source.unsplash.com/480x320/?alhambra,granada,spain"},
    {name:"Královský palác Madrid",    en:"Royal Palace of Madrid",    built:1738, finished:1764, img:"https://source.unsplash.com/480x320/?madrid,royal+palace,spain"},
    {name:"Park Güell",                en:"Park Güell",                built:1900, finished:1914, img:"https://source.unsplash.com/480x320/?park+guell,barcelona,gaudi"},
    {name:"Katedrála v Seville",       en:"Seville Cathedral",         built:1402, finished:1506, img:"https://source.unsplash.com/480x320/?seville,cathedral,spain"},
    {name:"Mesquita de Córdoba",       en:"Mosque-Cathedral of Córdoba",built:784, finished:987,  img:"https://source.unsplash.com/480x320/?cordoba,mezquita,spain"},
    {name:"Guggenheim Bilbao",         en:"Guggenheim Museum Bilbao",  built:1993, finished:1997, img:"https://source.unsplash.com/480x320/?guggenheim,bilbao,museum"},
    {name:"Aqueduct of Segovia",       en:"Aqueduct of Segovia",       built:50,   finished:98,   img:"https://source.unsplash.com/480x320/?segovia,aqueduct,spain"},
    {name:"El Escorial",               en:"El Escorial",               built:1563, finished:1584, img:"https://source.unsplash.com/480x320/?el+escorial,monastery,spain"},
    {name:"Montserrat klášter",        en:"Montserrat Monastery",      built:1025, finished:1592, img:"https://source.unsplash.com/480x320/?montserrat,monastery,spain"},
  ],
  JP:[
    {name:"Chrám Fushimi Inari",       en:"Fushimi Inari Shrine",      built:711,  finished:816,  img:"https://source.unsplash.com/480x320/?fushimi+inari,torii,kyoto"},
    {name:"Hora Fudži",                en:"Mount Fuji",                built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?mount+fuji,japan,volcano"},
    {name:"Chrám Kinkaku-ji",          en:"Kinkaku-ji Temple",         built:1397, finished:1955, img:"https://source.unsplash.com/480x320/?kinkakuji,golden+pavilion,kyoto"},
    {name:"Hirošima — Genbaku Dome",   en:"Hiroshima Peace Memorial",  built:1915, finished:1915, img:"https://source.unsplash.com/480x320/?hiroshima,peace+memorial,japan"},
    {name:"Tokio — Skytree",           en:"Tokyo Skytree",             built:2008, finished:2012, img:"https://source.unsplash.com/480x320/?tokyo+skytree,tower,japan"},
    {name:"Chrám Senso-ji",            en:"Senso-ji Temple",           built:645,  finished:645,  img:"https://source.unsplash.com/480x320/?sensoji,asakusa,tokyo"},
    {name:"Hrad Himeji",               en:"Himeji Castle",             built:1333, finished:1609, img:"https://source.unsplash.com/480x320/?himeji,castle,japan"},
    {name:"Itsukushima — torii",       en:"Itsukushima Shrine Torii",  built:593,  finished:1168, img:"https://source.unsplash.com/480x320/?itsukushima,torii+gate,miyajima"},
    {name:"Nara — Tōdai-ji",           en:"Tōdai-ji Temple Nara",      built:728,  finished:752,  img:"https://source.unsplash.com/480x320/?todaiji,nara,deer"},
    {name:"Tokijský palác",            en:"Tokyo Imperial Palace",     built:1457, finished:1968, img:"https://source.unsplash.com/480x320/?imperial+palace,tokyo,japan"},
  ],
  IN:[
    {name:"Tádž Mahal",               en:"Taj Mahal",                 built:1632, finished:1653, img:"https://source.unsplash.com/480x320/?taj+mahal,agra,india"},
    {name:"Qutb Minar",               en:"Qutb Minar",                built:1193, finished:1386, img:"https://source.unsplash.com/480x320/?qutb+minar,delhi,india"},
    {name:"Amritsar — Zlatý chrám",   en:"Golden Temple Amritsar",    built:1581, finished:1604, img:"https://source.unsplash.com/480x320/?golden+temple,amritsar,sikh"},
    {name:"Hrad Červená pevnost",     en:"Red Fort Delhi",             built:1638, finished:1648, img:"https://source.unsplash.com/480x320/?red+fort,delhi,india"},
    {name:"Chrám Slunce Konárak",     en:"Konark Sun Temple",          built:1250, finished:1264, img:"https://source.unsplash.com/480x320/?konark,sun+temple,india"},
    {name:"Jaipur — Hawa Mahal",      en:"Hawa Mahal Jaipur",         built:1799, finished:1799, img:"https://source.unsplash.com/480x320/?hawa+mahal,jaipur,india"},
    {name:"Hampi — ruiny",            en:"Hampi Ruins",               built:1336, finished:1565, img:"https://source.unsplash.com/480x320/?hampi,ruins,india"},
    {name:"Jeskynní chrámy Ajanta",   en:"Ajanta Caves",              built:-200, finished:480,  img:"https://source.unsplash.com/480x320/?ajanta,caves,india"},
    {name:"Mysuru — palác Amba Vilas",en:"Mysore Palace",             built:1897, finished:1912, img:"https://source.unsplash.com/480x320/?mysore,palace,india"},
    {name:"India Gate",               en:"India Gate",                built:1921, finished:1931, img:"https://source.unsplash.com/480x320/?india+gate,new+delhi,memorial"},
  ],
  CN:[
    {name:"Velká čínská zeď",          en:"Great Wall of China",       built:-700, finished:1644, img:"https://source.unsplash.com/480x320/?great+wall,china,beijing"},
    {name:"Zakázané město",            en:"Forbidden City",            built:1406, finished:1420, img:"https://source.unsplash.com/480x320/?forbidden+city,beijing,china"},
    {name:"Terakotová armáda",         en:"Terracotta Army",           built:-246, finished:-208, img:"https://source.unsplash.com/480x320/?terracotta+army,xian,china"},
    {name:"Letní palác Peking",        en:"Summer Palace Beijing",     built:1750, finished:1764, img:"https://source.unsplash.com/480x320/?summer+palace,beijing,china"},
    {name:"Pekinský olimpijský stadion",en:"Beijing National Stadium", built:2003, finished:2008, img:"https://source.unsplash.com/480x320/?birds+nest,beijing,stadium"},
    {name:"Potala palác Lhasa",        en:"Potala Palace Lhasa",       built:637,  finished:1694, img:"https://source.unsplash.com/480x320/?potala+palace,lhasa,tibet"},
    {name:"Machu Picchu — obdoba Huangshan", en:"Yellow Mountain Huangshan", built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?huangshan,yellow+mountain,china"},
    {name:"Šanghajská věž",            en:"Shanghai Tower",            built:2008, finished:2015, img:"https://source.unsplash.com/480x320/?shanghai,skyscraper,china"},
    {name:"Jeskynní chrámy Yungang",   en:"Yungang Grottoes",          built:460,  finished:525,  img:"https://source.unsplash.com/480x320/?yungang,buddhist,caves+china"},
    {name:"Tianmen — náměstí Peking",  en:"Tiananmen Square",          built:1415, finished:1420, img:"https://source.unsplash.com/480x320/?tiananmen,beijing,china"},
  ],
  US:[
    {name:"Socha Svobody",             en:"Statue of Liberty",         built:1875, finished:1886, img:"https://source.unsplash.com/480x320/?statue+of+liberty,new+york,usa"},
    {name:"Golden Gate Bridge",        en:"Golden Gate Bridge",        built:1933, finished:1937, img:"https://source.unsplash.com/480x320/?golden+gate,san+francisco,bridge"},
    {name:"Mount Rushmore",            en:"Mount Rushmore",            built:1927, finished:1941, img:"https://source.unsplash.com/480x320/?mount+rushmore,south+dakota,presidents"},
    {name:"Capitol Washington",        en:"United States Capitol",     built:1793, finished:1800, img:"https://source.unsplash.com/480x320/?capitol,washington+dc,usa"},
    {name:"Empire State Building",     en:"Empire State Building",     built:1930, finished:1931, img:"https://source.unsplash.com/480x320/?empire+state,new+york,skyscraper"},
    {name:"Bílý dům",                  en:"The White House",           built:1792, finished:1800, img:"https://source.unsplash.com/480x320/?white+house,washington,usa"},
    {name:"Grand Canyon",              en:"Grand Canyon",              built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?grand+canyon,arizona,usa"},
    {name:"Lincoln Memorial",          en:"Lincoln Memorial",          built:1914, finished:1922, img:"https://source.unsplash.com/480x320/?lincoln+memorial,washington+dc,usa"},
    {name:"Chrysler Building",         en:"Chrysler Building",         built:1928, finished:1930, img:"https://source.unsplash.com/480x320/?chrysler+building,new+york,art+deco"},
    {name:"One World Trade Center",    en:"One World Trade Center",    built:2006, finished:2014, img:"https://source.unsplash.com/480x320/?one+world+trade,new+york,freedom+tower"},
  ],
  BR:[
    {name:"Kristus Vykupitel",         en:"Christ the Redeemer",       built:1922, finished:1931, img:"https://source.unsplash.com/480x320/?christ+redeemer,rio+de+janeiro,brazil"},
    {name:"Iguazú — vodopády",         en:"Iguazu Falls",              built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?iguazu+falls,waterfall,brazil"},
    {name:"Stadión Maracanã",          en:"Maracanã Stadium",          built:1948, finished:1950, img:"https://source.unsplash.com/480x320/?maracana,stadium,rio"},
    {name:"Pelourinho Salvador",       en:"Pelourinho Salvador",       built:1549, finished:1700, img:"https://source.unsplash.com/480x320/?pelourinho,salvador,brazil"},
    {name:"Teatro Amazonas Manaus",    en:"Amazon Theatre Manaus",     built:1884, finished:1896, img:"https://source.unsplash.com/480x320/?teatro+amazonas,manaus,brazil"},
    {name:"Pão de Açúcar — hora",      en:"Sugarloaf Mountain",        built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?sugarloaf,rio+de+janeiro,brazil"},
    {name:"Kongresový palác Brasília", en:"Brazilian National Congress",built:1958,finished:1960, img:"https://source.unsplash.com/480x320/?national+congress,brasilia,brazil"},
    {name:"Catedral Brasília",         en:"Brasília Cathedral",        built:1958, finished:1970, img:"https://source.unsplash.com/480x320/?brasilia,cathedral,brazil"},
    {name:"Inhotim muzeum",            en:"Inhotim Museum",            built:2006, finished:2006, img:"https://source.unsplash.com/480x320/?inhotim,museum,brazil"},
    {name:"Mosteiro São Bento",        en:"São Bento Monastery",       built:1598, finished:1641, img:"https://source.unsplash.com/480x320/?sao+bento,monastery,brazil"},
  ],
  AU:[
    {name:"Opera v Sydney",            en:"Sydney Opera House",        built:1959, finished:1973, img:"https://source.unsplash.com/480x320/?sydney+opera,australia,harbour"},
    {name:"Uluru (Ayers Rock)",        en:"Uluru (Ayers Rock)",        built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?uluru,ayers+rock,australia"},
    {name:"Harbour Bridge Sydney",     en:"Sydney Harbour Bridge",     built:1923, finished:1932, img:"https://source.unsplash.com/480x320/?harbour+bridge,sydney,australia"},
    {name:"Velký bariérový útes",      en:"Great Barrier Reef",        built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?great+barrier+reef,coral,australia"},
    {name:"Parliament House Canberra", en:"Parliament House Canberra", built:1981, finished:1988, img:"https://source.unsplash.com/480x320/?canberra,parliament,australia"},
    {name:"Twelve Apostles Victoria",  en:"Twelve Apostles",           built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?twelve+apostles,victoria,australia"},
    {name:"Melbourne Federation Square",en:"Federation Square Melbourne",built:1997,finished:2002,img:"https://source.unsplash.com/480x320/?federation+square,melbourne,australia"},
    {name:"Kakadu National Park",      en:"Kakadu National Park",      built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?kakadu,national+park,australia"},
    {name:"Royal Exhibition Building", en:"Royal Exhibition Building", built:1879, finished:1880, img:"https://source.unsplash.com/480x320/?royal+exhibition,melbourne,heritage"},
    {name:"Fremantle Prison",          en:"Fremantle Prison",          built:1851, finished:1859, img:"https://source.unsplash.com/480x320/?fremantle,prison,western+australia"},
  ],
  EG:[
    {name:"Pyramidy v Gíze",           en:"Pyramids of Giza",          built:-2580,finished:-2560,img:"https://source.unsplash.com/480x320/?pyramids,giza,egypt"},
    {name:"Sfinga v Gíze",             en:"Great Sphinx of Giza",      built:-2558,finished:-2532,img:"https://source.unsplash.com/480x320/?sphinx,giza,egypt"},
    {name:"Chrám Abu Simbel",          en:"Abu Simbel Temples",        built:-1264,finished:-1244,img:"https://source.unsplash.com/480x320/?abu+simbel,temple,egypt"},
    {name:"Mešita Ibn Tuluna Káhira",  en:"Ibn Tulun Mosque Cairo",    built:876,  finished:879,  img:"https://source.unsplash.com/480x320/?ibn+tulun,mosque,cairo"},
    {name:"Karnak — chrámový komplex", en:"Karnak Temple Complex",     built:-2055,finished:-30,  img:"https://source.unsplash.com/480x320/?karnak,temple,luxor"},
    {name:"Alexandrijský maják (Citadela Qaitbay)",en:"Citadel of Qaitbay",built:1477,finished:1479,img:"https://source.unsplash.com/480x320/?qaitbay,citadel,alexandria"},
    {name:"Chrám Philae",              en:"Philae Temple",             built:-370, finished:-47,  img:"https://source.unsplash.com/480x320/?philae,temple,aswan"},
    {name:"Egyptské muzeum Káhira",    en:"Egyptian Museum Cairo",     built:1897, finished:1902, img:"https://source.unsplash.com/480x320/?egyptian+museum,cairo,antiquities"},
    {name:"Asuánská přehrada",         en:"Aswan High Dam",            built:1960, finished:1970, img:"https://source.unsplash.com/480x320/?aswan,dam,egypt"},
    {name:"Suezský průplav — Canal",   en:"Suez Canal",                built:1859, finished:1869, img:"https://source.unsplash.com/480x320/?suez+canal,egypt,ships"},
  ],
  ZA:[
    {name:"Stolová hora Kapské Město",  en:"Table Mountain Cape Town",  built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?table+mountain,cape+town,south+africa"},
    {name:"Robben Island",              en:"Robben Island",              built:1652, finished:1996, img:"https://source.unsplash.com/480x320/?robben+island,south+africa,mandela"},
    {name:"Johannesburg — Sandton City",en:"Sandton City Johannesburg",  built:1973, finished:1973, img:"https://source.unsplash.com/480x320/?johannesburg,skyline,south+africa"},
    {name:"Hrad Dobré naděje",          en:"Castle of Good Hope",        built:1666, finished:1679, img:"https://source.unsplash.com/480x320/?castle+good+hope,cape+town,fort"},
    {name:"Kruger National Park",       en:"Kruger National Park",       built:1898, finished:1926, img:"https://source.unsplash.com/480x320/?kruger,safari,south+africa"},
    {name:"Bloubergstrand — pohled",    en:"Boulders Beach Penguins",    built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?boulders+beach,penguins,cape+town"},
    {name:"Apartheid muzeum",           en:"Apartheid Museum",           built:1999, finished:2001, img:"https://source.unsplash.com/480x320/?apartheid+museum,johannesburg,south+africa"},
    {name:"Drakensberg",                en:"Drakensberg Mountains",      built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?drakensberg,mountains,south+africa"},
    {name:"Stellenbosch vinařství",     en:"Stellenbosch Vineyards",     built:1679, finished:1679, img:"https://source.unsplash.com/480x320/?stellenbosch,vineyard,south+africa"},
    {name:"Voortrekker Monument",       en:"Voortrekker Monument",       built:1938, finished:1949, img:"https://source.unsplash.com/480x320/?voortrekker,monument,pretoria"},
  ],
  AR:[
    {name:"Iguazú — vodopády",         en:"Iguazu Falls Argentina",    built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?iguazu+falls,argentina,waterfall"},
    {name:"Obelisco Buenos Aires",     en:"Obelisco Buenos Aires",     built:1936, finished:1936, img:"https://source.unsplash.com/480x320/?obelisco,buenos+aires,argentina"},
    {name:"Perito Moreno ledovec",     en:"Perito Moreno Glacier",     built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?perito+moreno,glacier,patagonia"},
    {name:"Teatro Colón Buenos Aires", en:"Teatro Colón",              built:1889, finished:1908, img:"https://source.unsplash.com/480x320/?teatro+colon,buenos+aires,opera"},
    {name:"La Boca — El Caminito",     en:"El Caminito Buenos Aires",  built:1959, finished:1959, img:"https://source.unsplash.com/480x320/?la+boca,buenos+aires,colorful"},
    {name:"Aconcagua",                 en:"Aconcagua",                 built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?aconcagua,andes,argentina"},
    {name:"Ushuaia — konec světa",     en:"Ushuaia End of the World",  built:1884, finished:1884, img:"https://source.unsplash.com/480x320/?ushuaia,patagonia,end+of+world"},
    {name:"Salta Cathedral",           en:"Salta Cathedral",           built:1582, finished:1882, img:"https://source.unsplash.com/480x320/?salta,cathedral,argentina"},
    {name:"Puerto Madryn — velryby",   en:"Puerto Madryn Peninsula Valdés",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?peninsula+valdes,whales,argentina"},
    {name:"Quebrada de Humahuaca",     en:"Quebrada de Humahuaca",     built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?humahuaca,gorge,argentina"},
  ],
  CA:[
    {name:"Niagarské vodopády",        en:"Niagara Falls",             built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?niagara+falls,waterfall,canada"},
    {name:"CN Tower Toronto",          en:"CN Tower Toronto",          built:1973, finished:1976, img:"https://source.unsplash.com/480x320/?cn+tower,toronto,canada"},
    {name:"Parlamentní budova Ottawa", en:"Parliament Hill Ottawa",    built:1859, finished:1866, img:"https://source.unsplash.com/480x320/?parliament+hill,ottawa,canada"},
    {name:"Banff National Park",       en:"Banff National Park",       built:1885, finished:1885, img:"https://source.unsplash.com/480x320/?banff,mountain,canada"},
    {name:"Old Quebec City",           en:"Old Quebec City",           built:1608, finished:1759, img:"https://source.unsplash.com/480x320/?old+quebec,chateau+frontenac,canada"},
    {name:"Chateau Frontenac",         en:"Château Frontenac",         built:1892, finished:1924, img:"https://source.unsplash.com/480x320/?chateau+frontenac,quebec,hotel"},
    {name:"Vancouver — Stanley Park",  en:"Stanley Park Vancouver",    built:1888, finished:1888, img:"https://source.unsplash.com/480x320/?stanley+park,vancouver,canada"},
    {name:"Bay of Fundy",              en:"Bay of Fundy",              built:-999, finished:-999, img:"https://source.unsplash.com/480x320/?bay+of+fundy,tides,canada"},
    {name:"Whistler — lyžařský resort",en:"Whistler Mountain Resort",  built:1914, finished:1965, img:"https://source.unsplash.com/480x320/?whistler,ski+resort,canada"},
    {name:"Butchart Gardens",en:"Butchart Gardens",built:1904,finished:1929,img:"https://source.unsplash.com/480x320/?butchart+gardens,victoria,canada"},
  ],
  UA:[
    {name:"Kyjevsko-pečerská lávra",en:"Kyiv Pechersk Lavra",built:1051,finished:1073,img:"https://source.unsplash.com/480x320/?kyiv,pechersk+lavra,ukraine"},
    {name:"Katedrála sv. Sofie Kyjev",en:"Saint Sophia Cathedral Kyiv",built:1011,finished:1018,img:"https://source.unsplash.com/480x320/?sofia,cathedral,kyiv"},
    {name:"Hrad Kamenec-Podilskij",en:"Kamianets-Podilskyi Castle",built:1362,finished:1434,img:"https://source.unsplash.com/480x320/?kamianets,castle,ukraine"},
    {name:"Chersonesos Taurika",en:"Chersonesus Taurica",built:-421,finished:-400,img:"https://source.unsplash.com/480x320/?chersonesus,ancient,crimea"},
    {name:"Hrad Sudak",en:"Sudak Fortress",built:212,finished:1423,img:"https://source.unsplash.com/480x320/?sudak,fortress,ukraine"},
    {name:"Zamek Korets",en:"Korets Castle Ukraine",built:1386,finished:1600,img:"https://source.unsplash.com/480x320/?korets,castle,ukraine"},
    {name:"Lviv — staré město",en:"Lviv Old Town",built:1256,finished:1700,img:"https://source.unsplash.com/480x320/?lviv,old+town,ukraine"},
    {name:"Sofijivka park Uman",en:"Sofiyivka Park Uman",built:1796,finished:1800,img:"https://source.unsplash.com/480x320/?sofiyivka,park,ukraine"},
    {name:"Olvia — antické město",en:"Olbia Ancient City",built:-647,finished:-400,img:"https://source.unsplash.com/480x320/?olbia,ancient,ruins"},
    {name:"Chreschtatyk bulvár Kyjev",en:"Khreshchatyk Boulevard Kyiv",built:1797,finished:1954,img:"https://source.unsplash.com/480x320/?khreshchatyk,boulevard,kyiv"},
  ],
  PL:[
    {name:"Wawel — hrad Krakov",en:"Wawel Royal Castle Krakow",built:1038,finished:1618,img:"https://source.unsplash.com/480x320/?wawel,castle,krakow"},
    {name:"Varšavské staré město",en:"Warsaw Old Town",built:1300,finished:1596,img:"https://source.unsplash.com/480x320/?warsaw,old+town,poland"},
    {name:"Auschwitz-Birkenau",en:"Auschwitz-Birkenau Memorial",built:1940,finished:1945,img:"https://source.unsplash.com/480x320/?auschwitz,memorial,poland"},
    {name:"Malbork — hrad řádu",en:"Malbork Castle",built:1274,finished:1406,img:"https://source.unsplash.com/480x320/?malbork,castle,poland"},
    {name:"Wieliczka — solné doly",en:"Wieliczka Salt Mine",built:1280,finished:1964,img:"https://source.unsplash.com/480x320/?wieliczka,salt+mine,poland"},
    {name:"Belověžský prales",en:"Białowieża Forest",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?bialowieza,forest,poland"},
    {name:"Zamość — renesanční město",en:"Zamość Old Town",built:1580,finished:1618,img:"https://source.unsplash.com/480x320/?zamosc,renaissance,poland"},
    {name:"Toruň — staré město",en:"Toruń Old Town",built:1233,finished:1264,img:"https://source.unsplash.com/480x320/?torun,old+town,poland"},
    {name:"Varšavský palác kultury",en:"Palace of Culture Warsaw",built:1952,finished:1955,img:"https://source.unsplash.com/480x320/?palace+of+culture,warsaw,poland"},
    {name:"Gniezno — katedrála",en:"Gniezno Cathedral",built:970,finished:1064,img:"https://source.unsplash.com/480x320/?gniezno,cathedral,poland"},
  ],
  SA:[
    {name:"Mešita al-Harám Mekka",en:"Al-Masjid al-Haram Mecca",built:638,finished:1955,img:"https://source.unsplash.com/480x320/?mecca,kaaba,mosque"},
    {name:"Mešita Proroka Medina",en:"Al-Masjid an-Nabawi Medina",built:622,finished:1994,img:"https://source.unsplash.com/480x320/?medina,mosque,islam"},
    {name:"Hegra — Mada'in Salih",en:"Hegra Mada'in Salih",built:-100,finished:100,img:"https://source.unsplash.com/480x320/?hegra,nabataean,saudi+arabia"},
    {name:"Diriyah — Turaif čtvrť",en:"Diriyah At-Turaif",built:1446,finished:1818,img:"https://source.unsplash.com/480x320/?diriyah,old+town,riyadh"},
    {name:"Jeddah — historické město",en:"Historic Jeddah",built:700,finished:1300,img:"https://source.unsplash.com/480x320/?jeddah,old+town,saudi+arabia"},
    {name:"Al-Ula — skalní město",en:"AlUla Rock City",built:-500,finished:700,img:"https://source.unsplash.com/480x320/?alula,rock,saudi+arabia"},
    {name:"Rijád — věž Kingdom Centre",en:"Kingdom Centre Tower Riyadh",built:1999,finished:2002,img:"https://source.unsplash.com/480x320/?riyadh,tower,saudi+arabia"},
    {name:"Zamek Masmak Rijád",en:"Masmak Fortress Riyadh",built:1865,finished:1865,img:"https://source.unsplash.com/480x320/?masmak,fortress,riyadh"},
    {name:"Rijád — King Fahd Fountain",en:"King Fahd Fountain Jeddah",built:1983,finished:1983,img:"https://source.unsplash.com/480x320/?king+fahd,fountain,jeddah"},
    {name:"Al-Ahsa Oasis",en:"Al-Ahsa Oasis",built:-3500,finished:-999,img:"https://source.unsplash.com/480x320/?oasis,palm+trees,desert"},
  ],
  NG:[
    {name:"Olumo skála Abeokuta",en:"Olumo Rock Abeokuta",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?olumo+rock,abeokuta,nigeria"},
    {name:"Yankari National Park",en:"Yankari National Park",built:1956,finished:1962,img:"https://source.unsplash.com/480x320/?yankari,savanna,nigeria"},
    {name:"Abuja — National Mosque",en:"Nigerian National Mosque Abuja",built:1984,finished:1984,img:"https://source.unsplash.com/480x320/?abuja,mosque,nigeria"},
    {name:"Osun-Osogbo posvátný háj",en:"Osun-Osogbo Sacred Grove",built:1600,finished:1800,img:"https://source.unsplash.com/480x320/?osun,sacred+grove,nigeria"},
    {name:"Abuja — Aso Rock",en:"Aso Rock Abuja",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?aso+rock,abuja,nigeria"},
    {name:"Lagos — Tafawa Balewa Square",en:"Tafawa Balewa Square Lagos",built:1961,finished:1961,img:"https://source.unsplash.com/480x320/?lagos,nigeria,independence"},
    {name:"Sukur kulturní krajina",en:"Sukur Cultural Landscape",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?sukur,nigeria,mountain"},
    {name:"Zuma Rock",en:"Zuma Rock Nigeria",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?zuma+rock,nigeria,monolith"},
    {name:"Oba's Palace Benin City",en:"Oba's Palace Benin City",built:900,finished:1500,img:"https://source.unsplash.com/480x320/?benin+city,palace,nigeria"},
    {name:"Victoria Island Lagos",en:"Victoria Island Lagos",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?lagos,victoria+island,nigeria"},
  ],
  MX:[
    {name:"Teotihuacán — Pyramidy",en:"Teotihuacan Pyramids",built:-200,finished:250,img:"https://source.unsplash.com/480x320/?teotihuacan,pyramid,mexico"},
    {name:"Chichén Itzá",en:"Chichen Itza",built:600,finished:900,img:"https://source.unsplash.com/480x320/?chichen+itza,mayan,mexico"},
    {name:"Palacio de Bellas Artes",en:"Palacio de Bellas Artes Mexico City",built:1904,finished:1934,img:"https://source.unsplash.com/480x320/?bellas+artes,mexico+city,art+deco"},
    {name:"Guanajuato — město",en:"Guanajuato City",built:1559,finished:1700,img:"https://source.unsplash.com/480x320/?guanajuato,colorful+houses,mexico"},
    {name:"Monte Albán",en:"Monte Albán",built:-500,finished:700,img:"https://source.unsplash.com/480x320/?monte+alban,ruins,oaxaca"},
    {name:"Palenque — mayské město",en:"Palenque Maya City",built:100,finished:800,img:"https://source.unsplash.com/480x320/?palenque,mayan,jungle"},
    {name:"Mexiko — katedrála",en:"Mexico City Cathedral",built:1573,finished:1813,img:"https://source.unsplash.com/480x320/?mexico+city,cathedral,zocalo"},
    {name:"Tulum — pobřežní ruiny",en:"Tulum Ruins",built:564,finished:1400,img:"https://source.unsplash.com/480x320/?tulum,mayan+ruins,beach"},
    {name:"Uxmal — mayské město",en:"Uxmal Maya City",built:700,finished:1000,img:"https://source.unsplash.com/480x320/?uxmal,mayan+pyramid,mexico"},
    {name:"Zócalo Mexico City",en:"Zócalo Mexico City",built:1325,finished:1524,img:"https://source.unsplash.com/480x320/?zocalo,mexico+city,square"},
  ],
  NZ:[
    {name:"Sky Tower Auckland",en:"Sky Tower Auckland",built:1994,finished:1997,img:"https://source.unsplash.com/480x320/?sky+tower,auckland,new+zealand"},
    {name:"Milford Sound Fiordland",en:"Milford Sound Fiordland",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?milford+sound,fiord,new+zealand"},
    {name:"Hobbiton — Matamata",en:"Hobbiton Movie Set",built:1999,finished:2012,img:"https://source.unsplash.com/480x320/?hobbiton,shire,new+zealand"},
    {name:"Rotorua — gejzíry",en:"Rotorua Geysers",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?rotorua,geysers,new+zealand"},
    {name:"Tongariro National Park",en:"Tongariro National Park",built:1887,finished:1887,img:"https://source.unsplash.com/480x320/?tongariro,volcano,new+zealand"},
    {name:"Te Papa muzeum Wellington",en:"Te Papa Museum Wellington",built:1998,finished:1998,img:"https://source.unsplash.com/480x320/?te+papa,wellington,museum"},
    {name:"Waitomo Caves",en:"Waitomo Glowworm Caves",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?waitomo,caves,new+zealand"},
    {name:"Queenstown — jezero Wakatipu",en:"Lake Wakatipu Queenstown",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?queenstown,lake,new+zealand"},
    {name:"Abel Tasman National Park",en:"Abel Tasman National Park",built:1942,finished:1942,img:"https://source.unsplash.com/480x320/?abel+tasman,coast,new+zealand"},
    {name:"Christchurch — katedrála",en:"Christchurch Cathedral",built:1864,finished:1904,img:"https://source.unsplash.com/480x320/?christchurch,cathedral,new+zealand"},
  ],
  AT:[
    {name:"Schönbrunnský palác",en:"Schönbrunn Palace Vienna",built:1696,finished:1730,img:"https://source.unsplash.com/480x320/?schonbrunn,palace,vienna"},
    {name:"Vídeňská opera",en:"Vienna State Opera",built:1861,finished:1869,img:"https://source.unsplash.com/480x320/?vienna+opera,austria,music"},
    {name:"Stephansdom Vídeň",en:"St. Stephen's Cathedral Vienna",built:1137,finished:1433,img:"https://source.unsplash.com/480x320/?stephansdom,vienna,austria"},
    {name:"Hallstatt — jezero a město",en:"Hallstatt Village",built:800,finished:1300,img:"https://source.unsplash.com/480x320/?hallstatt,lake,austria"},
    {name:"Melk — benediktinský klášter",en:"Melk Abbey",built:1702,finished:1736,img:"https://source.unsplash.com/480x320/?melk,abbey,austria"},
    {name:"Pevnost Hohensalzburg",en:"Hohensalzburg Fortress",built:1077,finished:1519,img:"https://source.unsplash.com/480x320/?hohensalzburg,salzburg,fortress"},
    {name:"Hofburg Vídeň",en:"Hofburg Palace Vienna",built:1279,finished:1913,img:"https://source.unsplash.com/480x320/?hofburg,vienna,imperial"},
    {name:"Belvedere palác Vídeň",en:"Belvedere Palace Vienna",built:1714,finished:1723,img:"https://source.unsplash.com/480x320/?belvedere,vienna,baroque"},
    {name:"Grossglockner — hora",en:"Grossglockner Mountain",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?grossglockner,mountain,austria"},
    {name:"Vídeň Prater — Riesenrad",en:"Vienna Prater Giant Wheel",built:1896,finished:1897,img:"https://source.unsplash.com/480x320/?prater,ferris+wheel,vienna"},
  ],
  BE:[
    {name:"Grand Place Brusel",en:"Grand Place Brussels",built:1401,finished:1455,img:"https://source.unsplash.com/480x320/?grand+place,brussels,belgium"},
    {name:"Atomium Brusel",en:"Atomium Brussels",built:1956,finished:1958,img:"https://source.unsplash.com/480x320/?atomium,brussels,belgium"},
    {name:"Bruggy — kanály",en:"Bruges Canals",built:1127,finished:1300,img:"https://source.unsplash.com/480x320/?bruges,canals,belgium"},
    {name:"Manneken Pis",en:"Manneken Pis Brussels",built:1388,finished:1619,img:"https://source.unsplash.com/480x320/?manneken+pis,brussels,belgium"},
    {name:"Gent — Gravensteen hrad",en:"Gravensteen Castle Ghent",built:1180,finished:1180,img:"https://source.unsplash.com/480x320/?gravensteen,ghent,castle"},
    {name:"Antverpy — katedrála",en:"Antwerp Cathedral",built:1352,finished:1521,img:"https://source.unsplash.com/480x320/?antwerp,cathedral,belgium"},
    {name:"Waterloo — bojiště",en:"Waterloo Battlefield",built:1815,finished:1815,img:"https://source.unsplash.com/480x320/?waterloo,battlefield,belgium"},
    {name:"Dinant — citadela",en:"Dinant Citadel",built:1051,finished:1050,img:"https://source.unsplash.com/480x320/?dinant,citadel,belgium"},
    {name:"Laeken — královský palác",en:"Laeken Royal Palace",built:1782,finished:1784,img:"https://source.unsplash.com/480x320/?laeken,royal+palace,brussels"},
    {name:"Gent — Belfort věž",en:"Ghent Belfry",built:1313,finished:1380,img:"https://source.unsplash.com/480x320/?ghent,belfry,belfort"},
  ],
  NL:[
    {name:"Rijksmuseum Amsterdam",en:"Rijksmuseum Amsterdam",built:1876,finished:1885,img:"https://source.unsplash.com/480x320/?rijksmuseum,amsterdam,museum"},
    {name:"Větrné mlýny Kinderdijk",en:"Kinderdijk Windmills",built:1738,finished:1740,img:"https://source.unsplash.com/480x320/?kinderdijk,windmills,netherlands"},
    {name:"Anne Frankův dům Amsterdam",en:"Anne Frank House Amsterdam",built:1635,finished:1635,img:"https://source.unsplash.com/480x320/?anne+frank,amsterdam,canal"},
    {name:"Keukenhof — tulipány",en:"Keukenhof Gardens",built:1949,finished:1950,img:"https://source.unsplash.com/480x320/?keukenhof,tulips,netherlands"},
    {name:"Rotterdam — Erasmusbrug",en:"Erasmus Bridge Rotterdam",built:1990,finished:1996,img:"https://source.unsplash.com/480x320/?erasmus+bridge,rotterdam,netherlands"},
    {name:"Utrecht — Dom Tower",en:"Dom Tower Utrecht",built:1321,finished:1382,img:"https://source.unsplash.com/480x320/?dom+tower,utrecht,netherlands"},
    {name:"Delft — staré město",en:"Delft Old Town",built:1246,finished:1400,img:"https://source.unsplash.com/480x320/?delft,old+town,netherlands"},
    {name:"Haarlem — katedrála",en:"Haarlem Cathedral",built:1390,finished:1520,img:"https://source.unsplash.com/480x320/?haarlem,cathedral,netherlands"},
    {name:"Maastricht — basilika",en:"St. Servatius Basilica Maastricht",built:560,finished:1200,img:"https://source.unsplash.com/480x320/?maastricht,basilica,netherlands"},
    {name:"Gouda — radnice",en:"Gouda City Hall",built:1448,finished:1459,img:"https://source.unsplash.com/480x320/?gouda,city+hall,netherlands"},
  ],
  PT:[
    {name:"Torre de Belém",en:"Tower of Belém Lisbon",built:1516,finished:1521,img:"https://source.unsplash.com/480x320/?belem+tower,lisbon,portugal"},
    {name:"Mosteiro dos Jerónimos",en:"Jerónimos Monastery Lisbon",built:1501,finished:1601,img:"https://source.unsplash.com/480x320/?jeronimos,monastery,lisbon"},
    {name:"Palác Pena Sintra",en:"Pena Palace Sintra",built:1838,finished:1854,img:"https://source.unsplash.com/480x320/?pena+palace,sintra,portugal"},
    {name:"Porto — Dom Luís most",en:"Dom Luís I Bridge Porto",built:1881,finished:1886,img:"https://source.unsplash.com/480x320/?ponte+luis,porto,portugal"},
    {name:"Évora — Dianin chrám",en:"Temple of Diana Évora",built:100,finished:200,img:"https://source.unsplash.com/480x320/?evora,roman+temple,portugal"},
    {name:"Quinta da Regaleira Sintra",en:"Quinta da Regaleira",built:1904,finished:1910,img:"https://source.unsplash.com/480x320/?quinta+regaleira,sintra,portugal"},
    {name:"Klášter Batalha",en:"Batalha Monastery",built:1386,finished:1517,img:"https://source.unsplash.com/480x320/?batalha,monastery,portugal"},
    {name:"Obidos — hradní město",en:"Óbidos Walled Town",built:308,finished:1200,img:"https://source.unsplash.com/480x320/?obidos,walled+town,portugal"},
    {name:"Coimbra — univerzita",en:"University of Coimbra",built:1290,finished:1537,img:"https://source.unsplash.com/480x320/?coimbra,university,portugal"},
    {name:"Algarve — Ponta da Piedade",en:"Ponta da Piedade Algarve",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?algarve,sea+cliffs,portugal"},
  ],
  SE:[
    {name:"Stockholmská radnice",en:"Stockholm City Hall",built:1911,finished:1923,img:"https://source.unsplash.com/480x320/?stockholm,city+hall,sweden"},
    {name:"Vasa muzeum Stockholm",en:"Vasa Museum Stockholm",built:1987,finished:1990,img:"https://source.unsplash.com/480x320/?vasa,museum,stockholm"},
    {name:"Gamla Stan Stockholm",en:"Gamla Stan Stockholm",built:1250,finished:1600,img:"https://source.unsplash.com/480x320/?gamla+stan,stockholm,old+town"},
    {name:"Drottningholm palác",en:"Drottningholm Palace",built:1662,finished:1756,img:"https://source.unsplash.com/480x320/?drottningholm,palace,sweden"},
    {name:"Visby — středověké město",en:"Visby Medieval Town",built:1150,finished:1400,img:"https://source.unsplash.com/480x320/?visby,medieval,sweden"},
    {name:"Icehotel Jukkasjärvi",en:"Icehotel Jukkasjärvi",built:1989,finished:1989,img:"https://source.unsplash.com/480x320/?icehotel,arctic,sweden"},
    {name:"Riksdag Stockholm",en:"Swedish Parliament Building",built:1897,finished:1905,img:"https://source.unsplash.com/480x320/?riksdag,stockholm,sweden"},
    {name:"Abba Museum Stockholm",en:"ABBA Museum Stockholm",built:2013,finished:2013,img:"https://source.unsplash.com/480x320/?abba,museum,stockholm"},
    {name:"Göteborský přístav",en:"Gothenburg Harbour",built:1621,finished:1700,img:"https://source.unsplash.com/480x320/?gothenburg,harbour,sweden"},
    {name:"Husaby kyrka",en:"Husaby Church Sweden",built:1000,finished:1150,img:"https://source.unsplash.com/480x320/?husaby,church,sweden"},
  ],
  DK:[
    {name:"Malá mořská víla Kodaň",en:"Little Mermaid Copenhagen",built:1912,finished:1913,img:"https://source.unsplash.com/480x320/?little+mermaid,copenhagen,denmark"},
    {name:"Tivoli Kodaň",en:"Tivoli Gardens Copenhagen",built:1843,finished:1843,img:"https://source.unsplash.com/480x320/?tivoli,gardens,copenhagen"},
    {name:"Kronborg hrad Helsingør",en:"Kronborg Castle Helsingør",built:1420,finished:1585,img:"https://source.unsplash.com/480x320/?kronborg,castle,denmark"},
    {name:"Roskilde katedrála",en:"Roskilde Cathedral",built:1170,finished:1280,img:"https://source.unsplash.com/480x320/?roskilde,cathedral,denmark"},
    {name:"Frederiksborg palác",en:"Frederiksborg Palace",built:1600,finished:1625,img:"https://source.unsplash.com/480x320/?frederiksborg,palace,denmark"},
    {name:"Nyhavn Kodaň",en:"Nyhavn Copenhagen",built:1671,finished:1673,img:"https://source.unsplash.com/480x320/?nyhavn,copenhagen,colorful"},
    {name:"Jelling runy",en:"Jelling Runic Stones",built:958,finished:965,img:"https://source.unsplash.com/480x320/?jelling,viking,denmark"},
    {name:"Legoland Billund",en:"Legoland Billund",built:1968,finished:1968,img:"https://source.unsplash.com/480x320/?legoland,billund,denmark"},
    {name:"Kodaňská opera",en:"Copenhagen Opera House",built:2001,finished:2004,img:"https://source.unsplash.com/480x320/?copenhagen,opera,denmark"},
    {name:"Aarhus — ARoS muzeum",en:"ARoS Aarhus Art Museum",built:2002,finished:2004,img:"https://source.unsplash.com/480x320/?aros,museum,aarhus"},
  ],
  FI:[
    {name:"Helsinky — katedrála",en:"Helsinki Cathedral",built:1830,finished:1852,img:"https://source.unsplash.com/480x320/?helsinki,cathedral,finland"},
    {name:"Suomenlinna — pevnost",en:"Suomenlinna Fortress",built:1748,finished:1772,img:"https://source.unsplash.com/480x320/?suomenlinna,fortress,finland"},
    {name:"Turku hrad",en:"Turku Castle",built:1280,finished:1290,img:"https://source.unsplash.com/480x320/?turku,castle,finland"},
    {name:"Olavinlinna hrad",en:"Olavinlinna Castle Savonlinna",built:1475,finished:1475,img:"https://source.unsplash.com/480x320/?olavinlinna,castle,finland"},
    {name:"Santa Claus Village Rovaniemi",en:"Santa Claus Village Rovaniemi",built:1985,finished:1985,img:"https://source.unsplash.com/480x320/?rovaniemi,santa+claus,lapland"},
    {name:"Koli National Park",en:"Koli National Park Finland",built:1991,finished:1991,img:"https://source.unsplash.com/480x320/?koli,national+park,finland"},
    {name:"Porvoo — staré město",en:"Porvoo Old Town",built:1346,finished:1400,img:"https://source.unsplash.com/480x320/?porvoo,old+town,finland"},
    {name:"Finlandia-talo Helsinki",en:"Finlandia Hall Helsinki",built:1967,finished:1971,img:"https://source.unsplash.com/480x320/?finlandia+hall,helsinki,finland"},
    {name:"Tampere — katedrála",en:"Tampere Cathedral",built:1902,finished:1907,img:"https://source.unsplash.com/480x320/?tampere,cathedral,finland"},
    {name:"Siida muzeum Inari",en:"Siida Museum Inari",built:1998,finished:1998,img:"https://source.unsplash.com/480x320/?inari,lapland,finland"},
  ],
  GR:[
    {name:"Akropolis Atény",en:"Acropolis of Athens",built:-447,finished:-432,img:"https://source.unsplash.com/480x320/?acropolis,athens,parthenon"},
    {name:"Meteorá — kláštery",en:"Meteora Monasteries",built:1356,finished:1483,img:"https://source.unsplash.com/480x320/?meteora,monasteries,greece"},
    {name:"Santorini — Oia",en:"Santorini Oia",built:1600,finished:1800,img:"https://source.unsplash.com/480x320/?santorini,oia,greece"},
    {name:"Delfská věštírna",en:"Delphi Oracle",built:-800,finished:-390,img:"https://source.unsplash.com/480x320/?delphi,oracle,greece"},
    {name:"Olympia — antická",en:"Ancient Olympia",built:-776,finished:-393,img:"https://source.unsplash.com/480x320/?olympia,ancient,greece"},
    {name:"Knóssos Kréta",en:"Knossos Palace Crete",built:-1900,finished:-1400,img:"https://source.unsplash.com/480x320/?knossos,crete,minoan"},
    {name:"Epidauros — divadlo",en:"Theatre of Epidaurus",built:-340,finished:-330,img:"https://source.unsplash.com/480x320/?epidaurus,ancient+theatre,greece"},
    {name:"Soluň — Bílá věž",en:"White Tower Thessaloniki",built:1535,finished:1536,img:"https://source.unsplash.com/480x320/?white+tower,thessaloniki,greece"},
    {name:"Mykonos — větrné mlýny",en:"Mykonos Windmills",built:1500,finished:1600,img:"https://source.unsplash.com/480x320/?mykonos,windmills,cyclades"},
    {name:"Rhodos — staré město",en:"Rhodes Old Town",built:408,finished:1523,img:"https://source.unsplash.com/480x320/?rhodes,old+town,greece"},
  ],
  RO:[
    {name:"Hrad Bran — Drakula",en:"Bran Castle Romania",built:1377,finished:1388,img:"https://source.unsplash.com/480x320/?bran+castle,transylvania,romania"},
    {name:"Parlamentní palác Bukurešť",en:"Palace of Parliament Bucharest",built:1984,finished:1997,img:"https://source.unsplash.com/480x320/?parliament,bucharest,romania"},
    {name:"Peles hrad Sinaia",en:"Peleș Castle Sinaia",built:1873,finished:1914,img:"https://source.unsplash.com/480x320/?peles,castle,romania"},
    {name:"Sighișoara — staré město",en:"Sighișoara Historic Centre",built:1191,finished:1400,img:"https://source.unsplash.com/480x320/?sighisoara,historic,romania"},
    {name:"Bukurešť — Arc de Triomphe",en:"Bucharest Arc de Triomphe",built:1922,finished:1936,img:"https://source.unsplash.com/480x320/?bucharest,arc+de+triomphe,romania"},
    {name:"Klášter Voroneț",en:"Voroneț Monastery Romania",built:1488,finished:1496,img:"https://source.unsplash.com/480x320/?voronet,painted+monastery,romania"},
    {name:"Timișoara — náměstí",en:"Timișoara Union Square",built:1728,finished:1800,img:"https://source.unsplash.com/480x320/?timisoara,square,romania"},
    {name:"Dunajská delta",en:"Danube Delta Romania",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?danube+delta,romania,nature"},
    {name:"Corvin Castle Hunedoara",en:"Corvin Castle Hunedoara",built:1440,finished:1480,img:"https://source.unsplash.com/480x320/?corvin,castle,hunedoara"},
    {name:"Cluj-Napoca — katedrála",en:"Cluj-Napoca Cathedral",built:1349,finished:1442,img:"https://source.unsplash.com/480x320/?cluj,cathedral,romania"},
  ],
  HU:[
    {name:"Budapešť — parlament",en:"Hungarian Parliament Building",built:1885,finished:1904,img:"https://source.unsplash.com/480x320/?budapest,parliament,hungary"},
    {name:"Budínský hrad",en:"Buda Castle Budapest",built:1265,finished:1749,img:"https://source.unsplash.com/480x320/?buda+castle,budapest,hungary"},
    {name:"Řetězový most Budapešť",en:"Chain Bridge Budapest",built:1840,finished:1849,img:"https://source.unsplash.com/480x320/?chain+bridge,budapest,danube"},
    {name:"Fisherman's Bastion Budapešť",en:"Fisherman's Bastion Budapest",built:1895,finished:1902,img:"https://source.unsplash.com/480x320/?fishermans+bastion,budapest,hungary"},
    {name:"Széchenyi lázně Budapešť",en:"Széchenyi Thermal Bath Budapest",built:1909,finished:1913,img:"https://source.unsplash.com/480x320/?szechenyi,thermal+bath,budapest"},
    {name:"Balaton — jezero",en:"Lake Balaton Hungary",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?lake+balaton,hungary,summer"},
    {name:"Eger — hrad",en:"Eger Castle Hungary",built:1248,finished:1568,img:"https://source.unsplash.com/480x320/?eger,castle,hungary"},
    {name:"Pécsi katedrála",en:"Pécs Cathedral Hungary",built:1009,finished:1891,img:"https://source.unsplash.com/480x320/?pecs,cathedral,hungary"},
    {name:"Tokajská vinařská oblast",en:"Tokaj Wine Region Hungary",built:1700,finished:1737,img:"https://source.unsplash.com/480x320/?tokaj,vineyard,hungary"},
    {name:"Hévíz — termální jezero",en:"Lake Hévíz Thermal Bath",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?heviz,thermal+lake,hungary"},
  ],
  SK:[
    {name:"Bratislavský hrad",en:"Bratislava Castle",built:907,finished:1562,img:"https://source.unsplash.com/480x320/?bratislava,castle,slovakia"},
    {name:"Spišský hrad",en:"Spiš Castle Slovakia",built:1209,finished:1780,img:"https://source.unsplash.com/480x320/?spis,castle,slovakia"},
    {name:"Bojnický zámek",en:"Bojnice Castle Slovakia",built:1113,finished:1910,img:"https://source.unsplash.com/480x320/?bojnice,castle,slovakia"},
    {name:"Vysoké Tatry",en:"High Tatras Mountains Slovakia",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?high+tatras,mountains,slovakia"},
    {name:"Banská Štiavnica",en:"Banská Štiavnica Mining Town",built:1156,finished:1747,img:"https://source.unsplash.com/480x320/?banska+stiavnica,mining+town,slovakia"},
    {name:"Vlkolinec — lidové stavby",en:"Vlkolínec Folk Architecture",built:1300,finished:1400,img:"https://source.unsplash.com/480x320/?vlkolinec,folk+architecture,slovakia"},
    {name:"Košice — katedrála",en:"St. Elisabeth Cathedral Košice",built:1320,finished:1508,img:"https://source.unsplash.com/480x320/?kosice,cathedral,slovakia"},
    {name:"Slovenský kras — jeskyně",en:"Slovak Karst Caves",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?domica,cave,slovakia"},
    {name:"Červený Kláštor",en:"Red Monastery Slovakia",built:1319,finished:1338,img:"https://source.unsplash.com/480x320/?red+monastery,pieniny,slovakia"},
    {name:"Čičmany — lidové vzory",en:"Čičmany Folk Village",built:1600,finished:1800,img:"https://source.unsplash.com/480x320/?cicmany,folk+patterns,slovakia"},
  ],
  HR:[
    {name:"Dubrovník — staré město",en:"Dubrovnik Old Town",built:614,finished:1667,img:"https://source.unsplash.com/480x320/?dubrovnik,old+town,croatia"},
    {name:"Diokleciánův palác Split",en:"Diocletian's Palace Split",built:295,finished:305,img:"https://source.unsplash.com/480x320/?split,diocletian,croatia"},
    {name:"Plitvická jezera",en:"Plitvice Lakes Croatia",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?plitvice,lakes,croatia"},
    {name:"Šibenik — katedrála",en:"Šibenik Cathedral",built:1431,finished:1536,img:"https://source.unsplash.com/480x320/?sibenik,cathedral,croatia"},
    {name:"Eufrazijská bazilika Poreč",en:"Euphrasian Basilica Poreč",built:553,finished:559,img:"https://source.unsplash.com/480x320/?porec,basilica,croatia"},
    {name:"Záhřeb — katedrála",en:"Zagreb Cathedral",built:1093,finished:1899,img:"https://source.unsplash.com/480x320/?zagreb,cathedral,croatia"},
    {name:"Zlatni Rat pláž Brač",en:"Zlatni Rat Beach Brač",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?zlatni+rat,beach,croatia"},
    {name:"Trogir — historické město",en:"Trogir Historic Town",built:-380,finished:1420,img:"https://source.unsplash.com/480x320/?trogir,historic,croatia"},
    {name:"Knin — hrad",en:"Knin Fortress Croatia",built:895,finished:1000,img:"https://source.unsplash.com/480x320/?knin,fortress,croatia"},
    {name:"Stari Grad Hvar",en:"Stari Grad Plain Hvar",built:-384,finished:-350,img:"https://source.unsplash.com/480x320/?hvar,island,croatia"},
  ],
  BG:[
    {name:"Rila — klášter",en:"Rila Monastery Bulgaria",built:927,finished:1335,img:"https://source.unsplash.com/480x320/?rila,monastery,bulgaria"},
    {name:"Alexander Nevský Sofie",en:"Alexander Nevsky Cathedral Sofia",built:1882,finished:1912,img:"https://source.unsplash.com/480x320/?alexander+nevsky,sofia,bulgaria"},
    {name:"Nesebăr — staré město",en:"Nesebăr Old Town Bulgaria",built:-700,finished:1000,img:"https://source.unsplash.com/480x320/?nessebar,old+town,black+sea"},
    {name:"Tsarevets — hrad Turnovo",en:"Tsarevets Fortress Turnovo",built:1185,finished:1393,img:"https://source.unsplash.com/480x320/?tsarevets,fortress,bulgaria"},
    {name:"Plovdiv — staré město",en:"Plovdiv Old Town Bulgaria",built:-400,finished:1800,img:"https://source.unsplash.com/480x320/?plovdiv,old+town,bulgaria"},
    {name:"Madara — jezdec",en:"Madara Rider Rock Relief",built:710,finished:710,img:"https://source.unsplash.com/480x320/?madara+rider,rock,bulgaria"},
    {name:"Boyana Church Sofie",en:"Boyana Church Sofia",built:1000,finished:1259,img:"https://source.unsplash.com/480x320/?boyana,church,sofia"},
    {name:"Thracké mohyly Kazanlak",en:"Thracian Tomb of Kazanlak",built:-325,finished:-300,img:"https://source.unsplash.com/480x320/?thracian,tomb,bulgaria"},
    {name:"Pirin National Park",en:"Pirin National Park Bulgaria",built:1962,finished:1962,img:"https://source.unsplash.com/480x320/?pirin,mountains,bulgaria"},
    {name:"Srebarna — přírodní rezervace",en:"Srebarna Nature Reserve",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?srebarna,lake,bulgaria"},
  ],
  MA:[
    {name:"Medína Fés",en:"Medina of Fez Morocco",built:789,finished:900,img:"https://source.unsplash.com/480x320/?fez,medina,morocco"},
    {name:"Hassan II mešita Casablanca",en:"Hassan II Mosque Casablanca",built:1986,finished:1993,img:"https://source.unsplash.com/480x320/?hassan+II,mosque,casablanca"},
    {name:"Ait Benhaddou kasbah",en:"Aït Benhaddou Kasbah",built:1100,finished:1300,img:"https://source.unsplash.com/480x320/?ait+benhaddou,kasbah,morocco"},
    {name:"Chefchaouen — modré město",en:"Chefchaouen Blue City",built:1471,finished:1471,img:"https://source.unsplash.com/480x320/?chefchaouen,blue+city,morocco"},
    {name:"Džamá el-Fná Marrákeš",en:"Jemaa el-Fna Marrakech",built:1050,finished:1100,img:"https://source.unsplash.com/480x320/?jemaa+el+fna,marrakech,morocco"},
    {name:"Volubilis — antické město",en:"Volubilis Roman Ruins",built:-300,finished:285,img:"https://source.unsplash.com/480x320/?volubilis,roman+ruins,morocco"},
    {name:"Saharské duny Merzouga",en:"Sahara Desert Dunes Merzouga",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?sahara,dunes,merzouga"},
    {name:"Essaouira — pobřežní město",en:"Essaouira Medina Morocco",built:1760,finished:1770,img:"https://source.unsplash.com/480x320/?essaouira,medina,morocco"},
    {name:"Bab Mansour Meknes",en:"Bab Mansour Gate Meknes",built:1672,finished:1732,img:"https://source.unsplash.com/480x320/?meknes,bab+mansour,morocco"},
    {name:"Medína Marrákeš",en:"Medina of Marrakech",built:1070,finished:1147,img:"https://source.unsplash.com/480x320/?marrakech,medina,riad"},
  ],
  ET:[
    {name:"Lalibela — skalní kostely",en:"Lalibela Rock-Hewn Churches",built:1150,finished:1250,img:"https://source.unsplash.com/480x320/?lalibela,rock+church,ethiopia"},
    {name:"Obelisk z Aksumu",en:"Obelisk of Axum Ethiopia",built:300,finished:350,img:"https://source.unsplash.com/480x320/?axum,obelisk,ethiopia"},
    {name:"Fasil Ghebbi Gondar",en:"Fasil Ghebbi Fortress Gondar",built:1636,finished:1667,img:"https://source.unsplash.com/480x320/?gondar,castle,ethiopia"},
    {name:"Simien Mountains",en:"Simien Mountains Ethiopia",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?simien,mountains,ethiopia"},
    {name:"Harar — walled city",en:"Walled City of Harar",built:1520,finished:1800,img:"https://source.unsplash.com/480x320/?harar,walled+city,ethiopia"},
    {name:"Tiya — prehistorické stély",en:"Tiya Megalithic Stelae",built:1000,finished:1300,img:"https://source.unsplash.com/480x320/?tiya,stelae,ethiopia"},
    {name:"Erta Ale — sopka",en:"Erta Ale Volcano Ethiopia",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?erta+ale,volcano,ethiopia"},
    {name:"Ethiopian Rift Valley",en:"Ethiopian Rift Valley",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?rift+valley,ethiopia,africa"},
    {name:"Holy Trinity Cathedral Addis",en:"Holy Trinity Cathedral Addis Ababa",built:1931,finished:1941,img:"https://source.unsplash.com/480x320/?addis+ababa,cathedral,ethiopia"},
    {name:"Yeha — starověký chrám",en:"Yeha Ancient Temple Ethiopia",built:-700,finished:-500,img:"https://source.unsplash.com/480x320/?yeha,temple,ethiopia"},
  ],
  KE:[
    {name:"Masai Mara — savana",en:"Maasai Mara Reserve Kenya",built:1961,finished:1961,img:"https://source.unsplash.com/480x320/?masai+mara,safari,kenya"},
    {name:"Hora Keňa",en:"Mount Kenya",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?mount+kenya,peak,africa"},
    {name:"Fort Jesus Mombasa",en:"Fort Jesus Mombasa Kenya",built:1593,finished:1596,img:"https://source.unsplash.com/480x320/?fort+jesus,mombasa,kenya"},
    {name:"Lamu — staré město",en:"Lamu Old Town Kenya",built:1370,finished:1400,img:"https://source.unsplash.com/480x320/?lamu,old+town,kenya"},
    {name:"Amboseli National Park",en:"Amboseli National Park Kenya",built:1974,finished:1974,img:"https://source.unsplash.com/480x320/?amboseli,elephant,kenya"},
    {name:"Nairobi National Park",en:"Nairobi National Park",built:1946,finished:1946,img:"https://source.unsplash.com/480x320/?nairobi,national+park,kenya"},
    {name:"Tsavo National Park",en:"Tsavo National Park Kenya",built:1948,finished:1948,img:"https://source.unsplash.com/480x320/?tsavo,red+elephants,kenya"},
    {name:"Lake Nakuru flamingos",en:"Lake Nakuru National Park",built:1961,finished:1968,img:"https://source.unsplash.com/480x320/?nakuru,flamingos,kenya"},
    {name:"Gede ruins Malindi",en:"Gede Ruins Malindi Kenya",built:1100,finished:1400,img:"https://source.unsplash.com/480x320/?gede,ruins,kenya"},
    {name:"Ngong Hills Nairobi",en:"Ngong Hills Nairobi",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?ngong+hills,nairobi,kenya"},
  ],
  TZ:[
    {name:"Kilimandžáro",en:"Mount Kilimanjaro Tanzania",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?kilimanjaro,tanzania,snow"},
    {name:"Serengeti National Park",en:"Serengeti National Park Tanzania",built:1951,finished:1951,img:"https://source.unsplash.com/480x320/?serengeti,wildebeest,tanzania"},
    {name:"Zanzibar — Stone Town",en:"Stone Town Zanzibar",built:1830,finished:1870,img:"https://source.unsplash.com/480x320/?zanzibar,stone+town,tanzania"},
    {name:"Ngorongoro kráter",en:"Ngorongoro Crater Tanzania",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?ngorongoro,crater,tanzania"},
    {name:"Kilwa Kisiwani — ruiny",en:"Kilwa Kisiwani Ruins",built:960,finished:1498,img:"https://source.unsplash.com/480x320/?kilwa,ruins,tanzania"},
    {name:"Zanzibar — pláže",en:"Zanzibar Beaches",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?zanzibar,beach,tanzania"},
    {name:"Olduvai Gorge",en:"Olduvai Gorge Tanzania",built:-1800000,finished:-1800000,img:"https://source.unsplash.com/480x320/?olduvai,gorge,tanzania"},
    {name:"Selous Game Reserve",en:"Selous Game Reserve Tanzania",built:1905,finished:1922,img:"https://source.unsplash.com/480x320/?selous,game+reserve,tanzania"},
    {name:"Tarangire National Park",en:"Tarangire National Park",built:1970,finished:1970,img:"https://source.unsplash.com/480x320/?tarangire,elephant,tanzania"},
    {name:"Mahale Mountains",en:"Mahale Mountains National Park",built:1985,finished:1985,img:"https://source.unsplash.com/480x320/?mahale,mountains,chimpanzee"},
  ],
  GH:[
    {name:"Cape Coast Castle Ghana",en:"Cape Coast Castle Ghana",built:1653,finished:1665,img:"https://source.unsplash.com/480x320/?cape+coast,castle,ghana"},
    {name:"Elmina Castle Ghana",en:"Elmina Castle Ghana",built:1482,finished:1486,img:"https://source.unsplash.com/480x320/?elmina,castle,ghana"},
    {name:"Black Star Square Accra",en:"Black Star Square Accra",built:1961,finished:1961,img:"https://source.unsplash.com/480x320/?accra,independence,ghana"},
    {name:"Kakum National Park Ghana",en:"Kakum National Park Ghana",built:1931,finished:1992,img:"https://source.unsplash.com/480x320/?kakum,canopy+walk,ghana"},
    {name:"Kumasi Ashanti Palace",en:"Kumasi Ashanti Palace",built:1700,finished:1700,img:"https://source.unsplash.com/480x320/?kumasi,ashanti,ghana"},
    {name:"Mole National Park Ghana",en:"Mole National Park Ghana",built:1958,finished:1971,img:"https://source.unsplash.com/480x320/?mole,national+park,ghana"},
    {name:"Larabanga mešita",en:"Larabanga Mosque Ghana",built:1421,finished:1421,img:"https://source.unsplash.com/480x320/?larabanga,mosque,ghana"},
    {name:"Wli — vodopády",en:"Wli Waterfalls Ghana",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?wli,waterfalls,ghana"},
    {name:"Jezero Volta Ghana",en:"Lake Volta Ghana",built:1964,finished:1965,img:"https://source.unsplash.com/480x320/?lake+volta,ghana,water"},
    {name:"Paga — krokodýlí jezero",en:"Paga Crocodile Pond",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?paga,crocodile,ghana"},
  ],
  CM:[
    {name:"Mont Cameroun — sopka",en:"Mount Cameroon Volcano",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?mount+cameroon,volcano,africa"},
    {name:"Waza National Park Cameroon",en:"Waza National Park",built:1934,finished:1968,img:"https://source.unsplash.com/480x320/?waza,wildlife,cameroon"},
    {name:"Foumban — palác sultána",en:"Foumban Sultan Palace",built:1394,finished:1400,img:"https://source.unsplash.com/480x320/?foumban,palace,cameroon"},
    {name:"Dja Faunal Reserve",en:"Dja Faunal Reserve Cameroon",built:1950,finished:1987,img:"https://source.unsplash.com/480x320/?dja,rainforest,cameroon"},
    {name:"Yaoundé — Basilika",en:"Yaoundé Basilica Cameroon",built:1962,finished:1965,img:"https://source.unsplash.com/480x320/?yaounde,cathedral,cameroon"},
    {name:"Rhumsiki — hora",en:"Rhumsiki Peak Cameroon",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?rhumsiki,peak,cameroon"},
    {name:"Kribi — pláže",en:"Kribi Beach Cameroon",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?kribi,beach,cameroon"},
    {name:"Limbe Botanical Garden",en:"Limbe Botanical Garden Cameroon",built:1892,finished:1892,img:"https://source.unsplash.com/480x320/?limbe,botanical+garden,cameroon"},
    {name:"Bamenda — ring road",en:"Bamenda Ring Road Cameroon",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?bamenda,ring+road,cameroon"},
    {name:"Maroua — trh",en:"Maroua Market Cameroon",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?maroua,market,cameroon"},
  ],
  AO:[
    {name:"Kalandula — vodopády",en:"Kalandula Falls Angola",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?kalandula,waterfall,angola"},
    {name:"Fortaleza São Miguel Luanda",en:"Fortaleza de São Miguel Luanda",built:1576,finished:1634,img:"https://source.unsplash.com/480x320/?luanda,fort,angola"},
    {name:"Tundavala Gap Angola",en:"Tundavala Gap Angola",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?tundavala,gap,angola"},
    {name:"Kissama National Park",en:"Kissama National Park Angola",built:1938,finished:1957,img:"https://source.unsplash.com/480x320/?kissama,park,angola"},
    {name:"Mbanza Kongo",en:"Mbanza Kongo Angola",built:1390,finished:1491,img:"https://source.unsplash.com/480x320/?mbanza+kongo,angola,africa"},
    {name:"Luanda katedrála",en:"Luanda Cathedral Angola",built:1628,finished:1628,img:"https://source.unsplash.com/480x320/?luanda,cathedral,angola"},
    {name:"Pungo Andongo — skály",en:"Pungo Andongo Rocks",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?pungo+andongo,rocks,angola"},
    {name:"Namibe poušť",en:"Namibe Desert Angola",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?namib,desert,angola"},
    {name:"Luanda Bay",en:"Luanda Bay Angola",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?luanda,bay,angola"},
    {name:"Dilolo jezero",en:"Dilolo Lake Angola",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?lake,angola,africa"},
  ],
  MZ:[
    {name:"Ilha de Moçambique",en:"Island of Mozambique",built:1507,finished:1600,img:"https://source.unsplash.com/480x320/?mozambique,island,heritage"},
    {name:"Gorongosa National Park",en:"Gorongosa National Park Mozambique",built:1920,finished:1960,img:"https://source.unsplash.com/480x320/?gorongosa,park,mozambique"},
    {name:"Maputo — železniční stanice",en:"Maputo Railway Station",built:1910,finished:1916,img:"https://source.unsplash.com/480x320/?maputo,railway+station,mozambique"},
    {name:"Quirimbas Archipelago",en:"Quirimbas Archipelago Mozambique",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?quirimbas,islands,mozambique"},
    {name:"Bazaruto Archipelago",en:"Bazaruto Archipelago Mozambique",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?bazaruto,archipelago,mozambique"},
    {name:"Cahora Bassa přehrada",en:"Cahora Bassa Dam Mozambique",built:1969,finished:1974,img:"https://source.unsplash.com/480x320/?cahora+bassa,dam,mozambique"},
    {name:"Maputo katedrála",en:"Maputo Cathedral Mozambique",built:1936,finished:1944,img:"https://source.unsplash.com/480x320/?maputo,cathedral,mozambique"},
    {name:"Inhambane katedrála",en:"Inhambane Cathedral Mozambique",built:1535,finished:1885,img:"https://source.unsplash.com/480x320/?inhambane,cathedral,mozambique"},
    {name:"Tofo Beach Mozambique",en:"Tofo Beach Mozambique",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?tofo,beach,mozambique"},
    {name:"Niassa Reserve",en:"Niassa Reserve Mozambique",built:1954,finished:1960,img:"https://source.unsplash.com/480x320/?niassa,reserve,mozambique"},
  ],
  CO:[
    {name:"Cartagena — pevnostní město",en:"Cartagena Walled City Colombia",built:1533,finished:1796,img:"https://source.unsplash.com/480x320/?cartagena,walled+city,colombia"},
    {name:"Ciudad Perdida — ztracené město",en:"Ciudad Perdida Lost City Colombia",built:800,finished:900,img:"https://source.unsplash.com/480x320/?ciudad+perdida,lost+city,colombia"},
    {name:"Salt Cathedral Zipaquirá",en:"Salt Cathedral Zipaquirá Colombia",built:1954,finished:1995,img:"https://source.unsplash.com/480x320/?salt+cathedral,zipaquira,colombia"},
    {name:"Caño Cristales — řeka barev",en:"Caño Cristales River Colombia",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?cano+cristales,river,colombia"},
    {name:"San Agustín — sochy",en:"San Agustín Archaeological Park",built:200,finished:900,img:"https://source.unsplash.com/480x320/?san+agustin,statues,colombia"},
    {name:"Bogotá — katedrála",en:"Bogotá Cathedral Colombia",built:1807,finished:1823,img:"https://source.unsplash.com/480x320/?bogota,cathedral,colombia"},
    {name:"Cocora Valley — palmy",en:"Cocora Valley Wax Palms Colombia",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?cocora,wax+palms,colombia"},
    {name:"Tayrona National Park",en:"Tayrona National Park Colombia",built:1964,finished:1969,img:"https://source.unsplash.com/480x320/?tayrona,beach,colombia"},
    {name:"Medellín — lanovky",en:"Medellín Cable Cars Colombia",built:2004,finished:2004,img:"https://source.unsplash.com/480x320/?medellin,cable+car,colombia"},
    {name:"Providencia Island",en:"Providencia Island Colombia",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?providencia,island,caribbean"},
  ],
  CL:[
    {name:"Ahu Tongariki — Velikonoční ostrov",en:"Ahu Tongariki Easter Island Chile",built:1400,finished:1500,img:"https://source.unsplash.com/480x320/?easter+island,moai,chile"},
    {name:"Torres del Paine",en:"Torres del Paine Chile",built:1959,finished:1959,img:"https://source.unsplash.com/480x320/?torres+del+paine,patagonia,chile"},
    {name:"Valparaíso — barevné domy",en:"Valparaíso Historic Quarter Chile",built:1536,finished:1800,img:"https://source.unsplash.com/480x320/?valparaiso,colorful,chile"},
    {name:"Atacamská poušť",en:"Atacama Desert Chile",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?atacama,desert,chile"},
    {name:"Chiloe — dřevěné kostely",en:"Chiloé Wooden Churches",built:1600,finished:1900,img:"https://source.unsplash.com/480x320/?chiloe,wooden+church,chile"},
    {name:"Santiago — Cerro Santa Lucía",en:"Cerro Santa Lucía Santiago Chile",built:1872,finished:1874,img:"https://source.unsplash.com/480x320/?santiago,santa+lucia,chile"},
    {name:"Lauca National Park",en:"Lauca National Park Chile",built:1970,finished:1970,img:"https://source.unsplash.com/480x320/?lauca,altiplano,chile"},
    {name:"Atacama Giant Geoglyph",en:"Atacama Giant Geoglyph",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?atacama,geoglyph,chile"},
    {name:"Punta Arenas — přístav",en:"Punta Arenas Port Chile",built:1848,finished:1900,img:"https://source.unsplash.com/480x320/?punta+arenas,patagonia,chile"},
    {name:"La Serena katedrála",en:"La Serena Cathedral Chile",built:1844,finished:1956,img:"https://source.unsplash.com/480x320/?la+serena,cathedral,chile"},
  ],
  PE:[
    {name:"Machu Picchu",en:"Machu Picchu Peru",built:1450,finished:1460,img:"https://source.unsplash.com/480x320/?machu+picchu,inca,peru"},
    {name:"Nazca — záhadné linie",en:"Nazca Lines Peru",built:-500,finished:-500,img:"https://source.unsplash.com/480x320/?nazca+lines,geoglyph,peru"},
    {name:"Cusco — historické centrum",en:"Cusco Historic Centre Peru",built:1100,finished:1400,img:"https://source.unsplash.com/480x320/?cusco,inca,peru"},
    {name:"Uros — plovoucí ostrovy Titicaca",en:"Uros Floating Islands Titicaca",built:1400,finished:1400,img:"https://source.unsplash.com/480x320/?uros,floating+islands,titicaca"},
    {name:"Chan Chan — hliněné město",en:"Chan Chan Adobe City Peru",built:850,finished:1470,img:"https://source.unsplash.com/480x320/?chan+chan,adobe,peru"},
    {name:"Arequipa — katedrála",en:"Arequipa Cathedral Peru",built:1544,finished:1656,img:"https://source.unsplash.com/480x320/?arequipa,cathedral,peru"},
    {name:"Colca Canyon Peru",en:"Colca Canyon Peru",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?colca,canyon,peru"},
    {name:"Kuélap — pevnost",en:"Kuélap Fortress Peru",built:500,finished:900,img:"https://source.unsplash.com/480x320/?kuelap,cloud+fortress,peru"},
    {name:"Paracas National Reserve",en:"Paracas National Reserve Peru",built:1975,finished:1975,img:"https://source.unsplash.com/480x320/?paracas,reserve,peru"},
    {name:"Chavín de Huántar",en:"Chavín de Huántar Peru",built:-900,finished:-200,img:"https://source.unsplash.com/480x320/?chavin,ruins,peru"},
  ],
  VE:[
    {name:"Angel Falls — Salto Ángel",en:"Angel Falls Venezuela",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?angel+falls,waterfall,venezuela"},
    {name:"Roraima — stolová hora",en:"Mount Roraima Venezuela",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?roraima,tepui,venezuela"},
    {name:"Canaima National Park",en:"Canaima National Park Venezuela",built:1962,finished:1962,img:"https://source.unsplash.com/480x320/?canaima,national+park,venezuela"},
    {name:"Los Roques archipelago",en:"Los Roques Archipelago Venezuela",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?los+roques,archipelago,venezuela"},
    {name:"Caracas katedrála",en:"Caracas Cathedral Venezuela",built:1614,finished:1713,img:"https://source.unsplash.com/480x320/?caracas,cathedral,venezuela"},
    {name:"Angostura Bridge",en:"Angostura Bridge Venezuela",built:1958,finished:1967,img:"https://source.unsplash.com/480x320/?angostura+bridge,venezuela,orinoco"},
    {name:"Morrocoy National Park",en:"Morrocoy National Park Venezuela",built:1974,finished:1974,img:"https://source.unsplash.com/480x320/?morrocoy,park,venezuela"},
    {name:"Mochima National Park",en:"Mochima National Park Venezuela",built:1973,finished:1973,img:"https://source.unsplash.com/480x320/?mochima,coast,venezuela"},
    {name:"Mérida lanovka",en:"Mérida Cable Car Venezuela",built:1957,finished:1960,img:"https://source.unsplash.com/480x320/?merida,cable+car,venezuela"},
    {name:"Karibské pobřeží Venezuely",en:"Venezuelan Caribbean Coast",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?venezuela,caribbean,beach"},
  ],
  CU:[
    {name:"Staré Havana — centro histórico",en:"Old Havana Historic Centre Cuba",built:1519,finished:1600,img:"https://source.unsplash.com/480x320/?havana,old+town,cuba"},
    {name:"El Capitolio Havana",en:"El Capitolio Havana Cuba",built:1926,finished:1929,img:"https://source.unsplash.com/480x320/?capitolio,havana,cuba"},
    {name:"Trinidad — kolonialní město",en:"Trinidad Colonial Town Cuba",built:1514,finished:1800,img:"https://source.unsplash.com/480x320/?trinidad,colonial,cuba"},
    {name:"Valle de Viñales",en:"Viñales Valley Cuba",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?vinales,valley,cuba"},
    {name:"Castillo del Morro Havana",en:"Castillo del Morro Havana Cuba",built:1589,finished:1630,img:"https://source.unsplash.com/480x320/?el+morro,havana,cuba"},
    {name:"Cienfuegos — urbanistika",en:"Cienfuegos Urban Heritage Cuba",built:1819,finished:1900,img:"https://source.unsplash.com/480x320/?cienfuegos,cuba,colonial"},
    {name:"Baracoa — první město",en:"Baracoa First Town Cuba",built:1511,finished:1511,img:"https://source.unsplash.com/480x320/?baracoa,cuba,oldest+town"},
    {name:"Havana Malecón",en:"Havana Malecón Cuba",built:1901,finished:1952,img:"https://source.unsplash.com/480x320/?malecon,havana,cuba"},
    {name:"Cayo Coco — pláže",en:"Cayo Coco Beaches Cuba",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?cayo+coco,beach,cuba"},
    {name:"Santiago de Cuba katedrála",en:"Santiago de Cuba Cathedral",built:1528,finished:1818,img:"https://source.unsplash.com/480x320/?santiago,cathedral,cuba"},
  ],
  EC:[
    {name:"Galápágy — ostrovy",en:"Galápagos Islands Ecuador",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?galapagos,tortoise,ecuador"},
    {name:"Quito — historické centrum",en:"Quito Historic Centre Ecuador",built:1534,finished:1700,img:"https://source.unsplash.com/480x320/?quito,old+town,ecuador"},
    {name:"Cotopaxi — sopka",en:"Cotopaxi Volcano Ecuador",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?cotopaxi,volcano,ecuador"},
    {name:"Mitad del Mundo — rovník",en:"Mitad del Mundo Monument Ecuador",built:1979,finished:1982,img:"https://source.unsplash.com/480x320/?mitad+del+mundo,equator,ecuador"},
    {name:"Cuenca — historické město",en:"Cuenca Historic Centre Ecuador",built:1557,finished:1800,img:"https://source.unsplash.com/480x320/?cuenca,cathedral,ecuador"},
    {name:"Yasuní National Park",en:"Yasuní National Park Ecuador",built:1979,finished:1979,img:"https://source.unsplash.com/480x320/?yasuni,amazon,ecuador"},
    {name:"La Compañía Church Quito",en:"La Compañía Church Quito",built:1605,finished:1765,img:"https://source.unsplash.com/480x320/?quito,jesuit+church,ecuador"},
    {name:"Ingapirca — inkské ruiny",en:"Ingapirca Inca Ruins Ecuador",built:1400,finished:1532,img:"https://source.unsplash.com/480x320/?ingapirca,inca+ruins,ecuador"},
    {name:"Baños — dobrodružné sporty",en:"Baños Adventure Town Ecuador",built:1861,finished:1861,img:"https://source.unsplash.com/480x320/?banos,ecuador,adventure"},
    {name:"Mindo — cloud forest",en:"Mindo Cloud Forest Ecuador",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?mindo,cloud+forest,ecuador"},
  ],
  PG:[
    {name:"Kokoda Track Papua",en:"Kokoda Track Papua New Guinea",built:1942,finished:1942,img:"https://source.unsplash.com/480x320/?kokoda,track,papua+new+guinea"},
    {name:"Mount Wilhelm Papua",en:"Mount Wilhelm Papua New Guinea",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?mount+wilhelm,papua,highland"},
    {name:"Rabaul — sopka Papua",en:"Rabaul Volcano Papua New Guinea",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?rabaul,volcano,papua"},
    {name:"Sepik řeka Papua",en:"Sepik River Papua New Guinea",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?sepik,river,papua"},
    {name:"Huli Wigmen Tari",en:"Tari Huli Wigmen Papua",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?huli,wigmen,papua"},
    {name:"Port Moresby parlament",en:"Port Moresby Parliament Papua",built:1984,finished:1984,img:"https://source.unsplash.com/480x320/?port+moresby,parliament,papua"},
    {name:"Madang pobřeží Papua",en:"Madang Coast Papua New Guinea",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?madang,coast,papua"},
    {name:"Tufi fjordy Papua",en:"Tufi Fjords Papua New Guinea",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?tufi,fjords,papua"},
    {name:"Varirata National Park",en:"Varirata National Park Papua",built:1968,finished:1968,img:"https://source.unsplash.com/480x320/?varirata,national+park,papua"},
    {name:"Loloata Island Papua",en:"Loloata Island Papua New Guinea",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?loloata,island,papua"},
  ],
  FJ:[
    {name:"Levuka — historické město",en:"Levuka Historical Port Town Fiji",built:1820,finished:1850,img:"https://source.unsplash.com/480x320/?levuka,historical+town,fiji"},
    {name:"Sigatoka Sand Dunes Fiji",en:"Sigatoka Sand Dunes Fiji",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?sigatoka,sand+dunes,fiji"},
    {name:"Yasawa Islands Fiji",en:"Yasawa Islands Fiji",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?yasawa,islands,fiji"},
    {name:"Tavoro Waterfalls Fiji",en:"Tavoro Waterfalls Fiji",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?tavoro,waterfalls,fiji"},
    {name:"Suva katedrála Fiji",en:"Suva Cathedral Fiji",built:1895,finished:1902,img:"https://source.unsplash.com/480x320/?suva,cathedral,fiji"},
    {name:"Sri Siva Subramaniya Nadi",en:"Sri Siva Subramaniya Temple Nadi",built:1926,finished:1926,img:"https://source.unsplash.com/480x320/?siva+subramaniya,temple,fiji"},
    {name:"Mamanuca Islands Fiji",en:"Mamanuca Islands Fiji",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?mamanuca,islands,fiji"},
    {name:"Taveuni Island Fiji",en:"Taveuni Island Fiji",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?taveuni,island,fiji"},
    {name:"Garden of the Sleeping Giant",en:"Garden of the Sleeping Giant Fiji",built:1977,finished:1977,img:"https://source.unsplash.com/480x320/?garden+sleeping+giant,fiji,orchid"},
    {name:"Denarau Island Fiji",en:"Denarau Island Fiji",built:1998,finished:2000,img:"https://source.unsplash.com/480x320/?denarau,fiji,resort"},
  ],
  WS:[
    {name:"To Sua Ocean Trench Samoa",en:"To Sua Ocean Trench Samoa",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?to+sua,ocean+trench,samoa"},
    {name:"Piula Cave Pool Samoa",en:"Piula Cave Pool Samoa",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?piula,cave+pool,samoa"},
    {name:"Lalomanu Beach Samoa",en:"Lalomanu Beach Samoa",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?lalomanu,beach,samoa"},
    {name:"Robert Louis Stevenson Museum",en:"Robert Louis Stevenson Museum Samoa",built:1891,finished:1894,img:"https://source.unsplash.com/480x320/?stevenson,museum,samoa"},
    {name:"Apia Cathedral Samoa",en:"Immaculate Conception Cathedral Apia",built:1885,finished:1905,img:"https://source.unsplash.com/480x320/?apia,cathedral,samoa"},
    {name:"Papapapaitai Falls Samoa",en:"Papapapaitai Falls Samoa",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?papapapaitai,falls,samoa"},
    {name:"Savai'i Island Samoa",en:"Savai'i Island Samoa",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?savaii,island,samoa"},
    {name:"National Museum of Samoa",en:"National Museum of Samoa",built:1984,finished:1984,img:"https://source.unsplash.com/480x320/?samoa,museum,apia"},
    {name:"Falealupo Rainforest Samoa",en:"Falealupo Rainforest Samoa",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?falealupo,rainforest,samoa"},
    {name:"Afu Aau Waterfall Samoa",en:"Afu Aau Waterfall Samoa",built:-999,finished:-999,img:"https://source.unsplash.com/480x320/?afu+aau,waterfall,samoa"},
  ],
};
// Fallback (should rarely be needed now)

const LANDMARK_FALLBACK = [
  {name:"Machu Picchu",en:"Machu Picchu",built:1450,finished:1460,img:"https://source.unsplash.com/480x320/?machu+picchu,inca,citadel"},
  {name:"Koloseum",en:"Colosseum",built:70,finished:80,img:"https://source.unsplash.com/480x320/?rome+colosseum+aerial,roman+amphitheatre,italy+ruins"},
  {name:"Eiffelova věž",en:"Eiffel Tower",built:1887,finished:1889,img:"https://source.unsplash.com/480x320/?eiffel+tower+night,paris+lights,iron+lattice"},
  {name:"Chrám Angkor Vat",en:"Angkor Wat",built:1113,finished:1150,img:"https://source.unsplash.com/480x320/?angkor+wat,cambodia,temple"},
  {name:"Tádž Mahal",en:"Taj Mahal",built:1632,finished:1653,img:"https://source.unsplash.com/480x320/?taj+mahal+sunrise,agra+india,white+marble+dome"},
  {name:"Big Ben",en:"Big Ben",built:1844,finished:1859,img:"https://source.unsplash.com/480x320/?big+ben,london,westminster"},
  {name:"Socha Svobody",en:"Statue of Liberty",built:1875,finished:1886,img:"https://source.unsplash.com/480x320/?liberty+statue+aerial,new+york+freedom,green+copper"},
  {name:"Velká čínská zeď",en:"Great Wall of China",built:-700,finished:1644,img:"https://source.unsplash.com/480x320/?great+wall+china+autumn,chinese+wall,mountain+fortress"},
  {name:"Pyramidy v Gíze",en:"Pyramids of Giza",built:-2580,finished:-2560,img:"https://source.unsplash.com/480x320/?giza+pyramid+camel,egypt+desert+sunset,ancient+wonder"},
  {name:"Opera v Sydney",en:"Sydney Opera House",built:1959,finished:1973,img:"https://source.unsplash.com/480x320/?sydney+opera+aerial,australia+landmark,white+sails"},
];
